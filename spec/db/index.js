...
// '@pear/dht-nodes' reconstruction function
function collection0_reconstruct (version, keyBuf, valueBuf) {
  const value = c.decode(resolveStruct('@pear/dht-nodes/value', version), valueBuf)
  return value
}
...
const collection0 = {
  ...
  encodeValue (version, record) {
    return c.encode(resolveStruct('@pear/dht-nodes/value', version), record)
  },
  trigger: null,
...
function resolveCollection (name) {
  switch (name) {
    case '@pear/dht-nodes': return collection0
