...
function resolveCollection (name) {
  switch (name) {
    ...
    case '@pear/traits': return collection3
    case '@pear/assets': return collection4
    case '@pear/current': return collection5
    case '@pear/presets': return collection7
    default: return null
  }
}
...
function resolveIndex (name) {
  switch (name) {
    case '@pear/traits-by-tags': return index6
    case '@pear/presets-by-command': return index8
    default: return null
  }
}
