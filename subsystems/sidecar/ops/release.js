...
const { ERR_RELEASE_ERROR, ERR_INVALID_CONFIG } = require('../../../errors')
...
module.exports = class Release extends Opstream {
  ...
  async #op ({ name, channel, checkout, link, dir }) {
    ...
    if (state.config.options.previewFor !== undefined) {
      throw ERR_INVALID_CONFIG('Config contains a \'previewFor\' property. This feature is only valid for pre-release.')
    }
