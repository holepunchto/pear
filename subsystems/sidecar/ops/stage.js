...
const { ERR_INVALID_CONFIG, ERR_SECRET_NOT_FOUND, ERR_PERMISSION_REQUIRED } = require('pear-api/errors')
...
module.exports = class Stage extends Opstream {
  ...
  async #op ({ channel, key, dir, dryRun, name, truncate, cmdArgs, ignore = '.git,.github,.DS_Store', ...params }) {
    ...
    const src = new LocalDrive(root, { followLinks: false, metadata: new Map() })
