...
class Engine extends ReadyResource {
  ...
  async start (params, client) {
    const { flags, env, link, dir } = params
    let { startId } = params
    ...
    const running = this.#start(flags, client, session, env, link, dir, startId)
