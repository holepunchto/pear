...
const wakeups = (listener) => messages({ type: 'pear/wakeup' }, listener)
...
// deprecated, remove after May 2024
const preferences = Object.assign(function preferences () {
  console.trace('🚨 Pear.preferences is deprecated. Do not use it.')
  ...
  del (key) {
    console.trace('🚨 Pear.preferences is deprecated. Do not use it.')
    return ipc.app.setPreference({ key, value: null })
  },
