...
const { TRACER_FAILED } = require('./errors')
...
module.exports = class Bundle {
  ...
  async finalizeTracing () {
    if (this.opened === false) throw TRACER_FAILED('Internal Platform Error: Bundle must be opened before warmup can commence')
    if (!this.tracer) throw TRACER_FAILED('Internal Platform Error: Bundle critical called without a tracer present')
