...
class Logger {
  constructor ({ labels, fields = '', stacks = false, level = 1, pretty = false, performanceLog = false } = {}) {
    ...
    if (performanceLog) {
      if (this.LEVEL < 2) this.LEVEL = 2
      this._labels.add('sidecar')
      this._show.level = true
      this._show.label = true
      this._show.date = true
      this._show.time = true
