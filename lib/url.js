...
const { isValid, decode } = require('hypercore-id-encoding')
const ALIASES = { // require('./constants') <-- throws an error when required
  keet: decode('oeeoz3w6fjjt7bym3ndpa6hhicm8f8naxyk11z4iypeoupn6jzpo'),
  runtime: decode('nkw138nybdx6mtf98z497czxogzwje5yzu585c66ofba854gw3ro')
}
