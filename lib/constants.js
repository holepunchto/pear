...
const PLATFORM = whichRuntime.platform
const ARCH = whichRuntime.arch

const BIN = 'by-arch/' + PLATFORM + '-' + ARCH + '/bin/'

const IS_WINDOWS = whichRuntime.isWindows
const IS_LINUX = whichRuntime.isLinux
const IS_MAC = whichRuntime.isMac
...
exports.IS_BARE = whichRuntime.isBare
exports.ARCH = ARCH
exports.PLATFORM = PLATFORM
exports.IS_ELECTRON = whichRuntime.isElectron
exports.IS_ELECTRON_RENDERER = whichRuntime.isElectronRenderer
exports.IS_ELECTRON_WORKER = whichRuntime.isElectronWorker
