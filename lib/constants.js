...
const BIN = 'by-arch/' + whichRuntime.platform + '-' + whichRuntime.arch + '/bin/'
...
const DESKTOP_EXEC = whichRuntime.isWindows
  ? 'pear-runtime-app/Pear Runtime.exe'
  : whichRuntime.isLinux
...
exports.SOCKET_PATH = whichRuntime.isWindows ? `\\\\.\\pipe\\${IPC_ID}` : `${PLATFORM_DIR}/${IPC_ID}.sock`
