...
class Worker {
  ...
  constructor ({ ref = noop, unref = noop, ipc = null, parent = null, applink = null, length = null, fork = null, unload = null } = {}) {
    this.#ref = ref
    this.#unref = unref
    this.#ipc = ipc
    this.#parent = parent
  ...
  run (link, args = []) {
    ...
    if (appKey && workerKey && b4a.equals(workerKey, appKey) && !workerFork && !workerLength) {
