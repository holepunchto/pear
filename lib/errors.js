...
function ERR_INSTANCE_CLOSED (msg) {
  return new PearError(msg, 'ERR_INSTANCE_CLOSED', PearError.ERR_INSTANCE_CLOSED)
}
...
function ERR_SHIFT_STORAGE_ERROR (msg) {
  return new PearError(msg, 'ERR_SHIFT_STORAGE_ERROR', PearError.ERR_SHIFT_STORAGE_ERROR)
}
...
function ERR_INVALID_APPLICATION_STORAGE (msg) {
  return new PearError(msg, 'ERR_INVALID_APPLICATION_STORAGE', PearError.ERR_INVALID_APPLICATION_STORAGE)
}
