...
class PearError extends Error {
  ...
  static ERR_INVALID_CHANNEL_NAME = ERR_INVALID_CHANNEL_NAME
...
function ERR_INVALID_CHANNEL_NAME (msg) {
  return new PearError(msg, 'ERR_INVALID_CHANNEL_NAME', ERR_INVALID_CHANNEL_NAME)
}
