...
class PearError extends Error {
  ...
  static ERR_ENCRYPTION_KEY_REQUIRED = ERR_ENCRYPTION_KEY_REQUIRED
  static ERR_ENCRYPTED_FIELD_REQUIRED = ERR_ENCRYPTED_FIELD_REQUIRED
  static ERR_INVALID_ENCRYPTION_KEY = ERR_INVALID_ENCRYPTION_KEY
  static ERR_NOT_FOUND_ENCRYPTION_KEY = ERR_NOT_FOUND_ENCRYPTION_KEY
...
function ERR_ENCRYPTED_FIELD_REQUIRED (msg) {
  return new PearError(msg, 'ERR_ENCRYPTED_FIELD_REQUIRED', ERR_ENCRYPTED_FIELD_REQUIRED)
}

function ERR_ENCRYPTION_KEY_REQUIRED (msg, key) {
...
function ERR_NOT_FOUND_ENCRYPTION_KEY (msg) {
  return new PearError(msg, 'ERR_NOT_FOUND_ENCRYPTION_KEY', ERR_NOT_FOUND_ENCRYPTION_KEY)
}
