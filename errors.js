...
class PearError extends Error {
  ...
  static ERR_MISSING_ENCRYPTION_KEY = ERR_MISSING_ENCRYPTION_KEY
...
function ERR_MISSING_ENCRYPTION_KEY (msg) {
  return new PearError(msg, 'ERR_MISSING_ENCRYPTION_KEY', ERR_MISSING_ENCRYPTION_KEY)
}
